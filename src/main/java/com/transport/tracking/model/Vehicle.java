...
public class Vehicle {
      ...
      @Column(name= "BPTNUMTYPE_0")
      private String bptnumType;
      @Column(name= "XVOL_0")
      private String xvol;
      @Column(name= "XWEU_0")
      private String xweu;
      ...
      @Column(name= "MONDAYRC")
      private String mondayRC;
      @Column(name= "TUESDAYRC")
      private String tuesdayRC;
      @Column(name= "WEDNESDAYRC")
      private String wednesdayRC;
      @Column(name= "THURSDAY")
      private String thursdayRC;
      @Column(name= "FRIDAY")
      private String fridayRC;
      @Column(name= "SATDAYRC")
      private String satdayRC;
      @Column(name= "SUNDAYRC")
      private String sundayRC;
      @Column(name= "MONDAYRCDESC")
      private String mondayRCDesc;
      @Column(name= "TUESDAYRCDESC")
      private String tuesdayRCDesc;
      @Column(name= "WEDNESDAYRCDESC")
      private String wednesdayRCDesc;
      @Column(name= "THURSDAYDESC")
      private String thursdayRCDesc;
      @Column(name= "FRIDAYDESC")
      private String fridayRCDesc;
      @Column(name= "SATDAYRCDESC")
      private String satdayRCDesc;
      @Column(name= "SUNDAYRCDESC")
      private String sundayRCDesc;
