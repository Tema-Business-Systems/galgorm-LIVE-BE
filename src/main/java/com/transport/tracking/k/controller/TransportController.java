...
// end of vrscreen
    ...
    public List<PickerList> getPickerList(AccessTokenVO accessTokenVO){

        return transportService.getPickerList();
    }


    @PostMapping ("/updatepicker")
    public @ResponseBody Map<String, String> SubmitVR(@RequestBody PickerVO request) throws Exception {
        //  log.info("inside Validate Controller");
        transportService.updatePicketByDocument(request);
        Map<String, String> map = new HashMap<>();
        map.put("success", "success");
        return map;
    }

    @PostMapping ("/updateroutecode")
    public @ResponseBody Map<String, String> SubmitVR(@RequestBody RouteCodeupdateVO request) throws Exception {
        //  log.info("inside Validate Controller");
        transportService.updateRouteCodeByDocument(request);
        Map<String, String> map = new HashMap<>();
        map.put("success", "success");
        return map;
    }
    ...
    public List<OpenToAddDocsVO> getToAddDocumentswithRange(AccessTokenVO accessTokenVO, @RequestParam(name = "site", required = false) List<String> site,
        ...
        return modifierService.getOpenToAddDocsWithRange(site, sdate,edate);
    }
