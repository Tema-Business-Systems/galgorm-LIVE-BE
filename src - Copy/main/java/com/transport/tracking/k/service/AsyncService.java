...
public class AsyncService {
 ...
 if(org.apache.commons.lang3.StringUtils.isNoneBlank(vehicle.getTrailer())) {
      ...
      /*  VehTrail vehTrail =  vehTrailRepository.findTrailerbyVehicleSiteandDate(Veh,vehsite,dddate);
        ...
        vehicleVO.setBptnumType(vehicle.getBptnumType());
...
//        }
        ...
        driverVO.setBptnumType(driver.getBptnumType());
        ...
        driverVO.setMondayflg(driver.getMondayflg());
        driverVO.setTuesdayflg(driver.getTuesdayflg());
        driverVO.setWednesdayflg(driver.getWednesdayflg());
        driverVO.setThursdayflg(driver.getThursdayflg());
        driverVO.setFridayflg(driver.getFridayflg());
        driverVO.setSatdayflg(driver.getSatdayflg());
        driverVO.setSundayflg(driver.getSundayflg());
