...
public class Driver {
      ...
      @Column(name= "XMONDAYFLG_0")
      private int mondayflg;
      @Column(name= "XTUESDAYFLG_0")
      private int tuesdayflg;
      @Column(name= "XWEDNESDAYFLG_0")
      private int wednesdayflg;
      @Column(name= "XTHURSDAYFLG_0")
      private int thursdayflg;
      @Column(name= "XFRIDAYFLG_0")
      private int fridayflg;
      @Column(name= "XSATDAYFLG_0")
      private int satdayflg;
      @Column(name= "XSUNDFLG_0")
      private int sundayflg;
}
